...
use crate::simulation::Sims;
use crate::color_method::ColorMethod::*;
use crate::neighbours::NeighbourMethod;
            ...
            ui.heading("Rules:");
            {
                ui.group(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        {
                            colour_picker(ui, &mut current.color1);
                            colour_picker(ui, &mut current.color2);
                        }
                        ...
                        ComboBox::from_label("Neighbour Method: ")
                            ...
                            .show_ui(ui, |ui| {
                                ui.selectable_value(&mut rule.neighbour_method, Moore, "Moore").on_hover_text("Maximum of 26 neighbours");
                                ui.selectable_value(
                            ...
                            ui.group(|ui| {
                                ...
                                ui.horizontal(|ui| {
                                    ...
                                    ui.vertical(|ui| {
                                        ...
                                        {
                                            rule.birth_rule = value_selector_ui(current.rule.unwrap().neighbour_method, spacing, ui, rule.birth_rule, "birth_grid");
                                            current.rule = Some(rule);
                                        }
                                    });
                                    ui.add_space(5.0);
                                    ...
                                    ui.vertical(|ui| {
                                        ...
                                        {
                                            rule.survival_rule = value_selector_ui(current.rule.unwrap().neighbour_method, spacing, ui, rule.survival_rule, "survival_grid");
                                            current.rule = Some(rule);
                                        }
                                    });
                                });
...
fn value_selector_ui(neighbour_method: NeighbourMethod, spacing: Vec2, ui: &mut Ui, mut value: Value, grid_id: &str) -> Value {
        ...
        ui, |ui| {
            for i in 1..=26 {
                ...
                if ui
                    ...
                    .on_hover_text("Click to select this value. If it is greyed out, try changing the neighbour_method :)").clicked() {
                    // Update the value
    ...
    ui.heading("Information:").on_hover_text("Information about the current simulation");
    {
        ui.group(|ui| {
            ...
            ui.vertical(|ui| {
                ...
                let cell_count: usize = current.sims[active_sim].1.cell_count();
